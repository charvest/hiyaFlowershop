...
$employeeSql = "SELECT user_id, email, employee_username, date FROM employee";
            ...
            <div class="activity">
                ...
                if ($employeeResult->num_rows > 0) {
                    while ($row = $employeeResult->fetch_assoc()) {
                        ...
                        echo "<div class='data username'><span class='data-title'>Username</span><span class='data-list'>" . htmlspecialchars($row["employee_username"]) . "</span></div>";
