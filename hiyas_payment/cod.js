document.addEventListener('DOMContentLoaded', function() {
    ...
    var cardInputs = document.querySelectorAll('#cc-name, #cc-number, #cc-expiration, #cc-cvv');
...
function setupFormSubmission() {
    document.getElementById('checkout-form').addEventListener('submit', function(event) {
        ...
        .then(products => {
            ...
            formData.append('payment_type', document.querySelector('input[name="paymentMethod"]:checked').value);
